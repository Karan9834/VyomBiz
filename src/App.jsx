...
import AppointmentandResignationofDirectors from "./pages/compliance/CompanySecretarial/AppointmentandResignationofDirectors";
import ChangeinRegisteredOffice from "./pages/compliance/CompanySecretarial/ChangeinRegisteredOffice";
import EventBasedCompliancesinaCompany from "./pages/compliance/CompanySecretarial/EventBasedCompliancesinaCompany";
import FormAOC4 from "./pages/compliance/CompanySecretarial/FormAOC4";
import LiquidationofCompany from "./pages/compliance/CompanySecretarial/LiquidationofCompany";
import RemovalofDirector from "./pages/compliance/CompanySecretarial/RemovalofDirector";
import RevivalofStruckOffCompanies from "./pages/compliance/CompanySecretarial/RevivalofStruckOffCompanies";
import SPICEForm from "./pages/compliance/CompanySecretarial/SPICEForm";
import Section8CompanyCompliance from "./pages/compliance/CompanySecretarial/Section8CompanyCompliance";
import WindingUpofPrivateLimitedCompany from "./pages/compliance/CompanySecretarial/WindingUpofPrivateLimitedCompany";
...
import ClosingLLP from "./pages/compliance/CompanySecretarial/ClosingLLP";
import AnnualFilingLLP from "./pages/compliance/CompanySecretarial/AnnualFilingLLP";
import ChangeInObjectClause from "./pages/compliance/CompanySecretarial/ChangeInObjectClause";
import MCACompliance from "./pages/compliance/CompanySecretarial/MCACompliance";


import AnnualCompliancePvtLtd from "./pages/compliance/CompanySecretarial/AnnualCompliancePvtLtd";
import EventBasedCompliances from "./pages/compliance/CompanySecretarial/EventBasedCompliances";
import ChangeInNameClause from "./pages/compliance/CompanySecretarial/ChangeInNameClause";
import NidhiCompanyCompliance from "./pages/compliance/CompanySecretarial/NidhiCompanyCompliance";
import NBFCCompliance from "./pages/compliance/CompanySecretarial/NBFCCompliance";
import ChangeInShareCapital from "./pages/compliance/CompanySecretarial/ChangeInShareCapital";
import ChangeInLLPAgreement from "./pages/compliance/CompanySecretarial/ChangeInLLPAgreement";
import AGRReturnFiling from "./pages/compliance/CompanySecretarial/AGRReturnFiling";
import FormMGT7 from "./pages/compliance/CompanySecretarial/FormMGT7";
import AGILEPROS from "./pages/compliance/CompanySecretarial/AGILEPROS";
