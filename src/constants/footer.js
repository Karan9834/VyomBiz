export const FOOTER_LINKS = {
    ...
    REGULATORY: [
        ...
        { name: "SEBI", path: "/regulatory" },
        { name: "IRDA", path: "/regulatory" },
        { name: "CDSCO", path: "/regulatory" },
        { name: "BIS", path: "/regulatory" },
        { name: "FEMA", path: "/regulatory" },
        { name: "Legal Metrology", path: "/regulatory" },
...
export const SECONDARY_FOOTER_LINKS = [
