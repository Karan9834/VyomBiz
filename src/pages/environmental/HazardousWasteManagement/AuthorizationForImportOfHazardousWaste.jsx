                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-[65%] space-y-8">
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
                            ...
                            <div className="text-slate-600 font-medium leading-relaxed space-y-4 text-lg">
                                <p>Hazardous Waste Management Rules have been notified to ensure secure handling , generation, processing, treatment, import, package, storage, transportation, reprocessing, collection, conversion, and offering for sale, destruction and disposal of Hazardous Waste.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
                            ...
                            <div className="text-slate-600 font-medium leading-relaxed space-y-4 text-lg">
                                <p>In order to import hazardous waste for recycling:
...
3. The state government will grant the NOC for import provided that the importer submits a valid informed consent letter with authenticated copy.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-[#072b47] rounded-3xl p-8 shadow-xl text-white">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    ...
                                    <span>Valid informed consent letter with authenticated copy from the exporting country</span>
                                </li>
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    <div className="mt-1 w-5 h-5 shrink-0 rounded-full bg-[#005a9c] flex items-center justify-center">
                                        <div className="w-1.5 h-1.5 bg-white rounded-full"></div>
