                    ...
                    <div className="w-full lg:w-[65%] space-y-8">
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
                            ...
                            <div className="text-slate-600 font-medium leading-relaxed space-y-4 text-lg">
                                <p>The term Hazardous Waste Management refers to all methods and regulations for handling Hazardous waste without endangering people or the environment. The primary goal of a Hazardous Waste Management and Compliance Assurance is to alter how hazardous waste is handled so that it may be transported, stored, and disposed of in a way that is safe for the environment.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
                            ...
                            <div className="text-slate-600 font-medium leading-relaxed space-y-4 text-lg">
                                <p>According to the Organization for Economic Cooperation and Development (OECD),4.4 million tonnes of Hazardous waste are produced annually. Hazardous Waste Management and Compliance Assurance has four main advantages: Equity, Effectiveness, Efficiency, Sustainability.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
                            ...
                            <div className="text-slate-600 font-medium leading-relaxed space-y-4 text-lg">
                                <p>1. Handling of Hazardous Wastes: precautions to safeguard health.
2. Transport of Hazardous Waste: Transporting to an authorised treatment, storage, or disposal facility.
3. Disposal: Secure landfill, deep wells, and bedrock disposal are a few options for eliminating waste.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-[#072b47] rounded-3xl p-8 shadow-xl text-white">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    ...
                                    <span>Aadhaar Card copy and PAN card copy of the applicant</span>
                                </li>
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    <div className="mt-1 w-5 h-5 shrink-0 rounded-full bg-[#005a9c] flex items-center justify-center">
                                        <div className="w-1.5 h-1.5 bg-white rounded-full"></div>
                                ...
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    ...
                                    <span>Rent/lease or proof of ownership</span>
                                </li>
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    <div className="mt-1 w-5 h-5 shrink-0 rounded-full bg-[#005a9c] flex items-center justify-center">
                                        <div className="w-1.5 h-1.5 bg-white rounded-full"></div>
                                    </div>
                                    <span>Factory license or trade license</span>
                                </li>
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    <div className="mt-1 w-5 h-5 shrink-0 rounded-full bg-[#005a9c] flex items-center justify-center">
                                        <div className="w-1.5 h-1.5 bg-white rounded-full"></div>
                                    </div>
                                    <span>Details of treatment storage and disposal facility (TSDFs)</span>
                                </li>
                            </ul>
                        </div>
