                    ...
                    <div className="w-full lg:w-[65%] space-y-8">
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
                            ...
                            <div className="text-slate-600 font-medium leading-relaxed space-y-4 text-lg">
                                <p>As the lifestyle of people undergoes significant change, different chemicals and products are used at home today and often, we are unaware that it is corrosive, explosive, flammable or toxic. These fall under dangerous wastes that should be kept out of wet and dry waste streams as they can be harmful to our health and for the environment also if not correctly disposed of. Proper hazardous waste management is required and to ensure that the state pollution control board provides hazardous waste management authorization.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
                            ...
                            <div className="text-slate-600 font-medium leading-relaxed space-y-4 text-lg">
                                <p>1. Apply to the state pollution control board file an application in Form I within 60 days period from the date of publication of these rules
                        ...
                        <div className="bg-[#072b47] rounded-3xl p-8 shadow-xl text-white">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    ...
                                    <span>Certificate of incorporation if it's a company/LLP</span>
                                </li>
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    <div className="mt-1 w-5 h-5 shrink-0 rounded-full bg-[#005a9c] flex items-center justify-center">
                                        <div className="w-1.5 h-1.5 bg-white rounded-full"></div>
                                ...
                                <li className="flex items-start gap-3 text-blue-100 font-medium">
                                    ...
                                    <span>Board resolution to appoint an authorized person</span>
                                </li>
                            </ul>
                        </div>
