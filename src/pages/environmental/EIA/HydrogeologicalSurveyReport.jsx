...
const services = [
    { title: "Hydrogeological Survey Report Consultation", desc: "Expert guidance and consultation for obtaining your Hydrogeological Survey Report smoothly and efficiently.", price: "₹2,999" },
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-12 mb-20">
                    <div className="w-full lg:w-[60%]">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#072b47] leading-[1.1] mb-8">
                            Hydrogeological <br className="hidden md:block" />
                            <span className="text-[#dead01]">Survey Report</span>
                        </h1>
                        <p className="text-xl text-slate-600 mb-12 max-w-2xl leading-relaxed font-medium">
                            End-to-end support for Hydrogeological Survey Report. We manage the entire lifecycle of compliance to ensure your business operations remain uninterrupted and legally sound.
                        </p>
                    ...
                    <div className="w-full lg:w-[40%] relative">
                        ...
                        <img src="/environmental/placeholder/hero.avif" alt="Hydrogeological Survey Report"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2">
                            <h2 className="text-3xl md:text-4xl font-bold text-[#072b47] mb-6">About Hydrogeological Survey Report</h2>
                            ...
                            <div className="space-y-6 text-[#072b47]/90 text-lg leading-relaxed font-medium">
                                <p>Ensuring compliance with Hydrogeological Survey Report is crucial for businesses operating in today's regulated environment under the broader framework of E I A. Failure to comply can result in severe legal consequences, operational halts, and financial penalties.</p>
