...
import { 
    ...
    Receipt, FileSpreadsheet, FileSignature, Handshake,
    FileDigit, FileCog, FilePlus, FileMinus, FileWarning,
    BookOpen, PenTool, Play
} from 'lucide-react';
    ...
    const contractServices = [
        {
            ...
            desc: "An SLA is a contract between the provider and the end-user, which defines the level of service that is expected from the provider. Get professionally drafted SLA for your business.",
            price: "₹2,999",
            link: "servicelevel-agreement",
            hasVideo: false
        },
        {
            title: "Share Purchase Agreement",
            desc: "Two parties, where one is a seller and the other is a buyer, enter into a Share Purchase Agreement. Get expert assistance in drafting comprehensive share purchase agreements.",
            price: "₹4,999",
        ...
        },
        {
            ...
            desc: "A legal, binding contract between the Franchisor and Franchisee. Get professionally drafted franchise agreements that protect your business interests.",
            price: "₹5,999",
        ...
        },
        {
            ...
            desc: "A well-drafted sale deed curtails all legal hazards and avoids vagueness. Vyombiz ensures realistic expectations with seamless interaction and expert drafting.",
            price: "₹3,999",
            link: "sale-deed-registration",
            hasVideo: false
        },
        {
            title: "Gift Deed",
            desc: "A well-drafted Gift deed curtails all legal hazards and avoids vagueness. We ensure realistic expectations with seamless interaction and expert drafting.",
            price: "₹2,999",
            link: "gift-deed-registration",
            hasVideo: false
        },
        {
            title: "Residential Rental Agreement",
            desc: "Get a well-drafted Residential Rental agreement to curtail all your legal hazards and avoid Litigations. You are just a phone call away from the finest drafting services.",
            price: "₹1,999",
            link: "residential-rental-agreement",
            hasVideo: false
        },
        {
            title: "Commercial Rental Agreement",
            desc: "Get a well-drafted Commercial Rental agreement to curtail all your legal hazards and avoid Litigations. Expert drafting for commercial properties.",
            price: "₹2,999",
        ...
        },
        {
            ...
            desc: "Get a well-drafted Relinquishment deed to curtail all your future legal threats and escape Litigations. Expert legal assistance for property matters.",
            price: "₹3,499",
            link: "online-relinquishment-deed",
            hasVideo: false
        },
        {
            title: "Probate of Will",
            desc: "For probate of will, there is a well-defined procedure established by the authorities. Our legal experts will help you with this process.",
            price: "₹4,999",
        ...
        },
        {
            ...
            desc: "Get a well-drafted Shareholder's agreement for determining the liaison between a company's shareholders and business, and to curtail all your legal hazards.",
            price: "₹5,499",
        ...
        },
        {
            ...
            desc: "Looking to get your Joint venture agreement drafted? Contact Vyombiz for expert legal assistance and comprehensive agreement drafting.",
            price: "₹6,999",
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12 py-6 md:py-10 lg:py-6">
                    ...
                    <div className="w-full lg:w-[60%] text-center lg:text-left">
                        ...
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-7xl font-black text-[#072b47] leading-[1.1] mb-4 md:mb-8 px-2 sm:px-0">
                            Drafting Service-related <br className="hidden sm:block" />
                            <span className="text-[#dead01]">Agreements</span> is Easy-to-go with Us
                        </h1>
                        <p className="text-base sm:text-lg md:text-xl text-slate-600 mb-6 md:mb-12 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium px-4 sm:px-0">
                            Drafting Service-related agreements has become easy now! Follow the streamlined process with Vyombiz to get the job done with expert legal guidance and comprehensive documentation.
                        </p>
                    ...
                    <div className="w-full lg:w-[40%] relative mt-8 lg:mt-0">
                        ...
                        <img
                            ...
                            onError={(e) => {
                                e.target.src = "https://illustrations.popsy.co/amber/contract.svg"
                            }}
                        />
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-8 md:mb-12 lg:mb-16">
                        ...
                        <p className="text-sm md:text-base lg:text-lg text-slate-600 font-medium max-w-2xl mx-auto px-4">
                            (We make legal documentation effortless and convenient.)
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Complete our simple form with your agreement requirements",
                                number: "1",
                                bgColor: "bg-[#005a9c]",
                                numberBg: "bg-[#dead01]"
                            },
                            ...
                            {
                                icon: <PenTool className="w-8 h-8 md:w-12 md:h-12 text-white" />,
                                title: "Expert Drafting",
                                desc: "Our legal experts draft your agreement",
                                number: "3",
                                bgColor: "bg-[#005a9c]",
                                numberBg: "bg-[#dead01]"
                            },
                            {
                                ...
                                title: "Get Agreement",
                                desc: "Receive your drafted agreement on email",
                                number: "4",
                                bgColor: "bg-[#dead01]",
                                numberBg: "bg-[#005a9c]",
                                textColor: "text-[#072b47]"
                        ...
                        {[
                            {
                                ...
                                desc: "Our team consists of experienced lawyers and legal professionals specializing in contract law and agreement drafting.",
                                icon: <Users className="w-6 h-6 md:w-8 md:h-8 text-[#dead01]" />
                            },
                            {
                                title: "Customized Drafting",
                                desc: "Every agreement is customized to your specific needs and requirements, ensuring comprehensive legal protection.",
                                icon: <FileCog className="w-6 h-6 md:w-8 md:h-8 text-[#dead01]" />
                            },
                            {
                                title: "Legally Valid & Enforceable",
                                desc: "All agreements are drafted as per Indian laws and are legally valid and enforceable in court of law.",
                                icon: <Scale className="w-6 h-6 md:w-8 md:h-8 text-[#dead01]" />
                            }
                        ].map((item, index) => (
                            <div
                                key={index}
