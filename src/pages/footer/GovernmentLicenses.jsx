                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-12 mb-20">
                    ...
                    <div className="w-full lg:w-[60%]">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-100 rounded-full text-yellow-400 text-sm font-bold uppercase tracking-wider mb-8">
                            ...
                            <span>Government Licenses</span>
                        </div>
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#072b47] leading-[1.1] mb-8">
                            Secure Government <br className="hidden md:block" />
                            <span className="text-[#dead01]">Licenses</span> Without Wasting Time!
                        </h1>
                        <p className="text-xl text-slate-600 mb-12 max-w-2xl leading-relaxed font-medium">
                            Want to acquire specific Government Licenses? Our experts can guide you through the regulatory process in a hassle-free manner across multiple civic and state departments.
                        </p>
                    ...
                    <div className="w-full lg:w-[40%] relative">
                        ...
                        <img
                            src="/Footer-pages/government-licenses/hero-image.avif"
                            alt="Government Licenses"
                            className="relative z-10 w-full h-auto object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-700"
                            onError={(e) => {
                                e.target.src = "https://illustrations.popsy.co/amber/contract-signing.svg"
                            }}
                        />
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-white rounded-[2rem] p-10 flex flex-col shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p className="text-slate-600 text-[15px] leading-relaxed font-medium">
                                Trusted by thousands for securing mandatory municipal, state, and central government licenses.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-[2rem] p-10 flex flex-col shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                            <div className="w-16 h-16 rounded-2xl bg-indigo-50 flex items-center justify-center mb-8">
                                <Star className="w-8 h-8 text-yellow-400" fill="currentColor" fillOpacity={0.2} />
                            </div>
                            <h3 className="text-xl font-bold text-[#072b47] mb-4">1 Lakh+ Brands</h3>
                            <p className="text-slate-600 text-[15px] leading-relaxed font-medium">
                                Global and local enterprises rely on us for seamless and continuous business compliance.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-[2rem] p-10 flex flex-col shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                            <div className="w-16 h-16 rounded-2xl bg-indigo-50 flex items-center justify-center mb-8">
                                <FileText className="w-8 h-8 text-yellow-400" fill="currentColor" fillOpacity={0.2} />
                            </div>
                            <h3 className="text-xl font-bold text-[#072b47] mb-4">Paperless Processing</h3>
                            <p className="text-slate-600 text-[15px] leading-relaxed font-medium">
                                We digitize the lengthy traditional documentation process allowing for faster government approvals.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-[2rem] p-10 flex flex-col shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p className="text-slate-600 text-[15px] leading-relaxed font-medium">
                                Comprehensive evaluations ensure that all granted licenses legally cover your precise business model.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        {[
                            { title: "Shop & Establishment License", desc: "Ensure your organized or unorganized sector business provides appropriate working conditions with local municipal compliance.", link: "/shop-establishment-license" },
                            { title: "CE Certification", desc: "Experiencing delays in getting your CE certification? Let our experts ease the process and get your products ready for the European market.", link: "/ce-certification" },
                            { title: "PSARA License", desc: "Worried about the challenges in PSARA License registration? We have helped 500+ business owners get private security licenses easily.", link: "/psara-license" },
                            { title: "Trade License", desc: "Seeking a trade license in India but unaware of the online process? We ensure a smooth trade license process with a 99% approval rate.", link: "/trade-license" },
                            { title: "Music License", desc: "Mandatory for artists and businesses wanting to make money from music. Cafes, restaurants, hotels, pubs require this compliance.", link: "/music-license" },
                            { title: "Health Trade License", desc: "If your business impacts public health, you must protect consumers. Get a health trade license and boost consumer trust seamlessly.", link: "/health-trade-license" }
                        ].map((service, index) => (
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2">
                            <h2 className="text-3xl md:text-4xl font-bold text-[#072b47] mb-6">
                                The Safest Way to Launch Your Business Legally
                            </h2>
                            ...
                            <div className="space-y-6 text-[#072b47]/90 text-lg leading-relaxed font-medium">
                                <p>
                                    Acquiring regulatory permits and federal licenses is the most critical hurdle faced by entrepreneurs. We simplify the entire procedure by undertaking the strenuous departmental follow-ups for you.
                                </p>
                                <p>
                                    Whether you're exporting pharmaceuticals, operating a hospitality venture, or running a highly technical telecommunications branch, our team guarantees that not a single operational roadblock occurs due to negligent compliance or mismatched licenses. Focus on scaling your business; we will handle the permits.
                                </p>
                            </div>
                        </div>
                        <div className="w-full lg:w-1/2 flex justify-center">
                            <img
                                src="/Footer-pages/government-licenses/overview.jpg"
                                alt="Licenses Overview"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-600 font-medium max-w-2xl mx-auto mt-6">
                            Follow these well-crafted steps to bypass bureaucratic hurdles and attain your licenses.
                        </p>
                    </div>
                            ...
                            {[
                                {
                                    ...
                                    desc: "Our advisors ensure your exact business model perfectly aligns with the required statutory license."
                                },
                                {
                                    num: "2",
                                    title: "Collation of Proofs",
                                    desc: "We analyze zoning laws and gather personal and corporate KYC documentation."
                                },
                                {
                                    num: "3",
                                    title: "Application Handling",
                                    desc: "Filing and constant follow-ups with relevant state sub-division bodies and civic authorities."
                                },
                                {
                                    num: "4",
                                    title: "Get Confirmation",
                                    desc: "Final delivery of authorized regulatory licenses, permits, and certificates directly to your mail."
                                }
                            ].map((step, index) => (
                        ...
                        {[
                            {
                                ...
                                desc: "Our connections within multiple civic organizations ensure applications rarely face redundant delays."
                            },
                            {
                                title: "Quick Processing",
                                desc: "Your licensing procedures are executed swiftly so that you face zero roadblocks for ongoing business operations."
                            },
                            {
                                title: "Complete Coverage",
                                desc: "Whether local retail trade licenses or international import-export telecom certifications, we cover everything."
                            }
                        ].map((item, index) => (
                            <div
                                key={index}
