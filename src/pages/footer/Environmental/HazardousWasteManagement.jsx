...
const HazardousWasteManagement = () => {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-12">
                    <div className="w-full lg:w-[60%]">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#072b47] leading-[1.2] mb-6">
                            Get Eco-smart Solutions for <span className="text-[#dead01]">Hazardous Waste Management</span>
                        </h1>
                        <p className="text-xl text-slate-600 mb-8 max-w-2xl leading-relaxed font-medium">
                            Hazardous Waste Management requires solutions to be treated efficiently. Contact us for efficient waste management planning
                        </p>
                    ...
                    <div className="w-full lg:w-[40%] relative">
                        ...
                        <img
                            src="/Footer-pages/service-banners/HazardousWasteManagement.avif"
                            alt="HazardousWasteManagement"
