                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-12">
                    <div className="w-full lg:w-[60%]">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#072b47] leading-[1.2] mb-6">
                            Get Pollution NOC and Contribute to <span className="text-[#dead01]">Sustainable Development</span>
                        </h1>
                        <p className="text-xl text-slate-600 mb-8 max-w-2xl leading-relaxed font-medium">
                            Want to get Pollution NOC and contribute to sustainable development programs? VyomBiz is the right channel to approach!
                        </p>
                    ...
                    <div className="w-full lg:w-[40%] relative">
                        <div className="absolute inset-0 bg-green-400/10 blur-[120px] rounded-full scale-150 animate-pulse"></div>
                        <img
                            src="/Footer-pages/pollution-noc/hero-image.avif"
                            alt="Pollution NOC"
                            className="relative z-10 w-full h-auto object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-700"
                            onError={(e) => { e.target.src = "https://illustrations.popsy.co/amber/working-vacation.svg" }}
                        />
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-[#FEF9C3]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                        {[
                            { name: "Rajesh Kumar", role: "Factory Owner", text: "VyomBiz made the entire Pollution NOC process completely hassle-free. Their team was professional and guided me through every step.", rating: 5 },
                            { name: "Sneha Patel", role: "Industrialist", text: "I was struggling with my CFE application for months before approaching them. They got it sorted and approved in record time.", rating: 5 },
                            { name: "Amit Singh", role: "Operations Head", text: "Excellent service! Their experts are very knowledgeable about SPCB compliance regulations. Highly recommend for any environmental licensing.", rating: 4 },
                        ].map((rev, idx) => (
