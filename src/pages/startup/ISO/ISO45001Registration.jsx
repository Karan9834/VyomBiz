...
const ISO45001Registration = () => {
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                heroTitleMain="ISO 45001"
                heroTitleSuffix="Certification"
                heroSubtitle="Occupational Health & Safety"
                heroDescription="Ensure workplace safety with ISO 45001 certification."
            ...
            <ISODetailsLayout
                overview={{
                    title: "Overview of ISO 45001",
                    description: [
                        "Ensure workplace safety with ISO 45001 certification.",
                ...
                advantages={{
                    title: "Benefits of ISO 45001 Certification",
