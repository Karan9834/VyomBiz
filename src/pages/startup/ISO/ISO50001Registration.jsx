...
const ISO50001Registration = () => {
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                heroTitleMain="ISO 50001"
                heroTitleSuffix="Certification"
                heroSubtitle="Energy Management System"
                heroDescription="Optimize energy efficiency with ISO 50001 certification."
            ...
            <ISODetailsLayout
                overview={{
                    title: "Overview of ISO 50001",
                    description: [
                        "Optimize energy efficiency with ISO 50001 certification.",
                ...
                advantages={{
                    title: "Benefits of ISO 50001 Certification",
