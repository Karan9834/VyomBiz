    ...
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                ...
                heroSubtitle="Risk Management"
                heroDescription="Implement effective risk management with ISO 31000."
            ...
            <ISODetailsLayout
                overview={{
                    title: "Overview of ISO 31000",
                    description: [
                        "Implement effective risk management with ISO 31000.",
                ...
                advantages={{
                    title: "Benefits of ISO 31000 Certification",
