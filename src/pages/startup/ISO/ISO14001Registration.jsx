    ...
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                ...
                heroDescription="Implement an effective Environmental Management System with ISO 14001 certification."
            ...
            <ISODetailsLayout
                overview={{
                    title: "Overview of ISO 14001 EMS",
                    description: [
                        "Implement an effective Environmental Management System with ISO 14001 certification.",
                ...
                advantages={{
                    title: "Benefits of ISO 14001 EMS Certification",
