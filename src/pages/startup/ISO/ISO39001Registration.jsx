...
const ISO39001Registration = () => {
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                heroTitleMain="ISO 39001"
                heroTitleSuffix="Certification"
                heroSubtitle="Road Traffic Safety"
                heroDescription="Reduce road traffic deaths and serious injuries."
            ...
            <ISODetailsLayout
                ...
                advantages={{
                    title: "Benefits of ISO 39001 Certification",
