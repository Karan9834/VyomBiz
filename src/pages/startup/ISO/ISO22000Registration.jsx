    ...
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                ...
                heroDescription="Ensure food safety throughout the supply chain with ISO 22000."
            ...
            <ISODetailsLayout
                overview={{
                    title: "Overview of ISO 22000 FSMS",
                    description: [
                        "Ensure food safety throughout the supply chain with ISO 22000.",
                ...
                advantages={{
                    title: "Benefits of ISO 22000 FSMS Certification",
