    ...
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                ...
                heroSubtitle="Adventure Tourism Safety"
                heroDescription="Safety management for adventure tourism providers."
            ...
            <ISODetailsLayout
                overview={{
                    title: "Overview of ISO 21101:2014",
                    description: [
                        "Safety management for adventure tourism providers.",
                ...
                advantages={{
                    title: "Benefits of ISO 21101:2014 Certification",
