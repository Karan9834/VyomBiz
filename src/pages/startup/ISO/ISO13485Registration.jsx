    ...
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                ...
                heroSubtitle="Medical Devices Quality Management"
                heroDescription="Quality management for medical device manufacturers."
            ...
            <ISODetailsLayout
                ...
                advantages={{
                    title: "Benefits of ISO 13485 Certification",
