    ...
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                ...
                heroSubtitle="IT Service Management"
                heroDescription="Improve IT service delivery with ISO 20000 certification."
            ...
            <ISODetailsLayout
                overview={{
                    title: "Overview of ISO 20000",
                    description: [
                        "Improve IT service delivery with ISO 20000 certification.",
                ...
                advantages={{
                    title: "Benefits of ISO 20000 Certification",
