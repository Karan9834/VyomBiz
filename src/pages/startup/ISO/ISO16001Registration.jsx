    ...
    return (
        <div className="w-full bg-white font-sans text-[#1a1a1a]">
            <HeroLayout
                ...
                heroSubtitle="Complaints Management"
                heroDescription="Effective complaints management system certification."
            ...
            <ISODetailsLayout
                overview={{
                    title: "Overview of ISO 16001",
                    description: [
                        "Effective complaints management system certification.",
                ...
                advantages={{
                    title: "Benefits of ISO 16001 Certification",
