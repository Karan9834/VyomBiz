...
import benefits from "../../../assets/FSSAI & Eating License/eating-house-license/benefits.jpeg";
import overview from "../../../assets/FSSAI & Eating License/eating-house-license/overview.jpg";
import process from "../../../assets/FSSAI & Eating License/eating-house-license/process.jpg";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16 lg:gap-24">
                    <div>
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold text-[#072b47] leading-[1.15] tracking-tight mb-6">
                            Eating House License – <span className="text-yellow-400">Overview</span>
                        </h2>
