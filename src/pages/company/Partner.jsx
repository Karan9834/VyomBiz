  ...
  return (
    <PageTemplate title='Partner'>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://VyomBiz.io/admin/style/images/content/20230323114210_partner-banner.png')",
        ...
        <div className="max-w-[1600px] mx-15 px-6 grid grid-cols-1 lg:grid-cols-2 gap-96 items-start">
          ...
          <div>
            <h2 className="text-[44px] leading-[46px] font-extrabold text-[#222] mb-10">
              Benefits of Partnering <br /> with VyomBiz
            </h2>
      ...
      <section className="bg-[#f9fafb] py-20">
        <div className="max-w-[1600px] mx-10 px-6 grid grid-cols-1 lg:grid-cols-2 gap-26 items-center">
            ...
            <div className="space-y-8">
              ...
              {[
                ...
                <div key={index} className="flex gap-5 items-start">
                  ...
                  {/* ICON */}
                  <img
                    src="https://VyomBiz.io/admin/style/images/userfiles/image/market-icon1.png"
                    alt="icon"
          ...
          <div className="flex justify-center lg:justify-end">
            <img
              src="https://VyomBiz.io/admin/style/images/userfiles/image/choose-us-icon.png"
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://VyomBiz.io/img/growing-partner-banner.png')",
        }}
      >
