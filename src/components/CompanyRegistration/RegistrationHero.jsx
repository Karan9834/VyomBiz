                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full mb-8">
                            ...
                            <span className="text-sm font-bold uppercase tracking-wider">Fastest Registration in India</span>
                        </div>

                        <h1 className="text-4xl lg:text-6xl font-black mb-6 leading-[1.1]">
                            Pvt. Ltd. <span className="text-secondary">Company</span> <br />
                            Registration in <span className="text-secondary">7 Days</span>
                        </h1>

                        <p className="text-xl text-slate-300 mb-10 leading-relaxed max-w-xl">
                            Simplify your business journey with VyomBiz. Start your Private Limited company with expert legal assistance and 100% money-back guarantee.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4 items-center">
                            ...
                            <p className="text-sm text-slate-400">
                                Trusted by <span className="text-white font-bold">50,000+</span> entrepreneurs across India
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-2xl text-slate-800">
                        <div className="mb-8">
                            ...
                            <p className="text-slate-500 font-medium">Connect with our experts in 60 seconds</p>
                        </div>
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:border-secondary focus:ring-4 focus:ring-secondary/10 outline-none transition-all font-medium appearance-none">
                            ...
                            <button className="w-full py-4 bg-primary text-white font-black rounded-xl shadow-lg shadow-primary/20 hover:bg-primary/90 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 mt-4 group">
