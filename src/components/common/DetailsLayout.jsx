        ...
        <div className="bg-white">
            ...
            <div className="container mx-auto px-6 lg:px-24">
                ...
                {advantages && (
                    ...
                    >
                        {React.isValidElement(advantages) ? (
                            advantages
                        ) : (
                            <>
                ...
                {eligibility && (
                    ...
                    >
                        {React.isValidElement(eligibility) ? (
                            eligibility
                        ) : (
                ...
                {documents && (
                    <section
                        ...
                        className="py-16 md:py-24 border-b border-slate-50 scroll-mt-24"
                    >
                        {React.isValidElement(documents) ? (
                            documents
                        ) : (
