...
const cards = [
  ...
  {
    img: "https://corpbiz.io/img/client-satisfaction.svg",
    title: "Hassle-free Registration",
    desc: "Corpbiz has made the registration process easy. You can leave the hassle of registration to us and focus on other important works that might require your immediate attention.",
  },
  {
    img: "https://corpbiz.io/img/excellent-advisory-service.png",
...
const points = [
  ...
  "Hassle-free Registration: Corpbiz has made the registration process easy. You can leave the hassle of registration to us and focus on other important works that might require your immediate attention.",
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-gray-700 mb-6">
            Corpbiz is a tech-driven platform committed to delivering professional services all over India. We deliver exceptional services to our clients, and our dedication and commitment can be seen in the following ways:
          </p>
